...
PALETTES: dict[str, dict[str, str]] = {
    "dark": {
        ...
        "accent_press": "#e0b833",
        "accent_text":  "#1a1304",
        "accent_tint":  "rgba(240, 200, 74, 0.08)",
        "accent_tint2": "rgba(240, 200, 74, 0.06)",
        "accent_sel":   "rgba(240, 200, 74, 0.18)",
        "accent_focus": "rgba(240, 200, 74, 0.30)",
        "teal":         "#7ab7d0",
        "input_bg":     "#11151c",
        "scroll":       "#2a3245",
        "scroll_hover": "#3a4358",
    ...
    "light": {
        ...
        "accent_press": "#9a7022",
        "accent_text":  "#fffbf2",
        "accent_tint":  "rgba(184, 132, 42, 0.08)",
        "accent_tint2": "rgba(184, 132, 42, 0.06)",
        "accent_sel":   "rgba(184, 132, 42, 0.18)",
        "accent_focus": "rgba(184, 132, 42, 0.30)",
        "teal":         "#2f6a86",
        "input_bg":     "#ffffff",
        "scroll":       "#c8c2ad",
        "scroll_hover": "#a8a288",
